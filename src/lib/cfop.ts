...
// Apenas os CFOPs cadastrados no dicionário oficial acima entram na apuração.
// Qualquer código fora dessa lista é ignorado de propósito (não é incluído
// no relatório nem somado), por ser o comportamento que o relatório do
// usuário precisa.
